...
// ticketPriceTotal = runners.reduce((total, inc) => {
//   return {donation: total.donation + inc.donation}
// });

let ticketPriceTotal = runners.reduce((total, obj) => {return total + obj.donation;}, 0);
...
// Problem 1
// Create an email list of all participants.
let email_list = [];
runners.forEach((element) => {
...
// Problem 2
// Create a list of people who donated at least $100
let donorList = [];
runners.forEach((element) => {
  if(element.donation >= 100)
  donorList.push(element.first_name + " " + element.last_name);
});
console.log(donorList);

// Problem 3
let skinixRunners = runners.filter(element => element.company_name == "Skinix");
